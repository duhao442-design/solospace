...
export const GamePage: React.FC = () => {
  ...
  const { state, selectedCards, aiPlay, aiPass, setProcessing, isProcessing, resetGame, selectCard } = useGameStore();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-table-dark via-table-green to-table-dark relative overflow-hidden">
      ...
      <div className="relative h-screen flex flex-col">
        <div className="absolute top-4 left-4 flex items-center gap-4 z-20">
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-800/80 rounded-lg text-white hover:bg-gray-700 transition-all"
          >
            <Home size={18} />
            返回
          </motion.button>
          <div className="bg-gray-800/80 rounded-lg px-4 py-2 text-white">
